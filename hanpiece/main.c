...
int crocodile_turn(Player* luffy, Player* crocodile) {
	...
	case 1:
		...
		printf("루피 : %d - %d = %d\n", luffy->hp, crocodile->atk, luffy->hp - crocodile->atk);
